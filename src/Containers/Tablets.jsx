...
import  {Tabletadd_1, Tabletadd_2, Tabletadd_3} from '..//Components/Tablet_adds';
        ...
        return(
            <div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col"><h4>Tablets</h4></div>
                ...
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <div id="CT-Mobile">
                            <hr/>
                        <ul>
                                <li className= "User-Ad"><Tabletadd_1/></li>
                                <li className= "User-Ad"><Tabletadd_2/></li>
                                <li className= "User-Ad"><Tabletadd_3/></li>
                            </ul>
                        </div>
