...
import  {TVadd_1, TVadd_2, TVadd_3} from '..//Components/TV_adds';
        ...
        return(
            <div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col"><h4>TV-Video-Audio</h4></div>
                ...
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <div id="CT-Mobile">
                            <hr/>
                        <ul>
                                <li className= "User-Ad"><TVadd_1/></li>
                                <li className= "User-Ad"><TVadd_2/></li>
                                <li className= "User-Ad"><TVadd_3/></li>
                            </ul>
                        </div>
