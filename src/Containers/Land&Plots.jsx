...
import  {Plotadd_1, Plotadd_2, Plotadd_3} from '..//Components/Plot_adds';
        ...
        return(
            <div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col"><h4>Land & Plots</h4></div>
                ...
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <div id="CT-Mobile">
                            <hr/>
                        <ul>
                                <li className= "User-Ad"><Plotadd_1/></li>
                                <li className= "User-Ad"><Plotadd_2/></li>
                                <li className= "User-Ad"><Plotadd_3/></li>
                            </ul>
                        </div>
