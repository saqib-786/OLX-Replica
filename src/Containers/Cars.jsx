...
import {Caradd_1, Caradd_2,Caradd_3} from '..//Components/Cars_add';
import Footer_2 from '../Components/Footr_2';
        ...
        return(
            <div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col"><h4>Cars</h4></div>
                ...
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <div id="CT-Mobile">
                            <hr/>
                        <ul>
                                <li className= "User-Ad"><Caradd_1/></li>
                                <li className= "User-Ad"><Caradd_2/></li>
                                <li className= "User-Ad"><Caradd_3/></li>
                            </ul>
                        </div>
