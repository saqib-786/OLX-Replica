...
import {Mobileadd_1, Mobileadd_2, Mobileadd_3} from '..//Components/Mobile_adds';
        ...
        return(
            <div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col"><h4>Mobile Phones</h4></div>
                ...
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <div id="CT-Mobile">
                            <hr/>
                        <ul>
                                <li className= "User-Ad"><Mobileadd_1/></li>
                                <li className= "User-Ad"><Mobileadd_2/></li>
                                <li className= "User-Ad"><Mobileadd_3/></li>
                            </ul>
                        </div>
