...
import {Bikeadd_1, Bikeadd_2, Bikeadd_3} from '..//Components/Bikes_add';
        ...
        return(
            <div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col"><h4>Motorcycles</h4></div>
                ...
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <div id="CT-Mobile">
                            <hr/>
                        <ul>
                                <li className= "User-Ad"><Bikeadd_1/></li>
                                <li className= "User-Ad"><Bikeadd_2/></li>
                                <li className= "User-Ad"><Bikeadd_3/></li>
                            </ul>
                        </div>
